      ...
      <CardContent className="space-y-6">
        <div>
          ...
          {crops.length > 0 ? (
            ...
            <p className="text-muted-foreground">No specific crops could be recommended based on the input. Try adjusting the values.</p>
          )}
        </div>
        ...
        <div className="border-t pt-4">
            <h3 className="text-md font-semibold mb-2">Important Considerations:</h3>
