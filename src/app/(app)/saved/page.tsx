    ...
    <div className="container mx-auto">
      ...
      <Tabs defaultValue="calendars" className="w-full">
        <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 h-auto">
          <TabsTrigger value="calendars" className="py-2.5 text-sm md:text-base">
            <CalendarDays className="mr-2 h-4 w-4" />
            Calendars
          </TabsTrigger>
          <TabsTrigger value="costs" className="py-2.5 text-sm md:text-base">
            <Calculator className="mr-2 h-4 w-4" />
            Cost Reports
          </TabsTrigger>
          <TabsTrigger value="irrigation" className="py-2.5 text-sm md:text-base">
            <Droplets className="mr-2 h-4 w-4" />
            Irrigation
          </TabsTrigger>
          <TabsTrigger value="health" className="py-2.5 text-sm md:text-base">
